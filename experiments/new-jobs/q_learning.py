...
def Q_learning(env, env_eval, options, Q, gamma, gamma_env, eps, alpha, max_steps, eval_steps, adaptive_gamma, _seed):
    exp_ret = []
    steps_per_episode = []
            ...
            for j, alpha in enumerate(args.alpha_values):
                for k, init_value in enumerate(args.initial_values):
                    for seed in range(args.n_seeds):
                        ...
                        Q, exp_ret, steps = Q_learning(env, env_eval, options, Q, gamma, gamma_env, 1.0, alpha, args.max_steps, args.eval_steps, args.adaptive_gamma, seed)
