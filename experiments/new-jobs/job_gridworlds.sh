...
python q_learning_2.py \
    --environments "Gym-Gridworlds/Empty-10x10-v0" "Gym-Gridworlds/Empty-Distract-6x6-v0" "Gym-Gridworlds/Penalty-3x3-v0" "Gym-Gridworlds/Quicksand-4x4-v0" "Gym-Gridworlds/Quicksand-Distract-4x4-v0" "Gym-Gridworlds/TwoRoom-Quicksand-3x5-v0" "Gym-Gridworlds/Full-4x5-v0" "Gym-Gridworlds/TwoRoom-Distract-Middle-2x11-v0" "Gym-Gridworlds/Barrier-5x5-v0" \
    --adaptive_gamma \
