...
def extract_performance(env, results):
    ...
    std_err = np.nanstd(optimal) / np.sqrt(len(optimal))
    ...
    for alpha in alphas:
        ...
        for env_name in environments:
            ...
            for init in q_inits:
                ...
                adaptive_mean, adaptive_ci = extract_performance(env_name, adaptive_results)
                fixed_mean, fixed_ci = extract_performance(env_name, fixed_results)
                fixed_mean2, fixed_ci2 = extract_performance(env_name, fixed_results2)
            ...
            print(f"{env_name} data")
            print("gamma=0.5", "means:", fixed_means2, "std_err:", fixed_cis2)
            print("gamma=0.99","means:", fixed_means, "std_err:",fixed_cis)
            print("adaptive gamma", "means:",adaptive_means, "std_err:",adaptive_cis)
            ...
            ax.set_ylabel("Number of steps for which it learns optimal policy out of 600")
